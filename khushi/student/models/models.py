def create_model(opt):
    ...
    if opt.model == 'cycle_gan':
    ...
    elif opt.model == 'cycle_attn_gan_sar_izma':
        from .cycle_attn_gan_model_sar_izma import CycleAttnGANModel_sar
        model = CycleAttnGANModel_sar()
    ...
    elif opt.model == 'pix2pix_attn_d2':
        from .pix2pix_attn_d2_model import Pix2Pix_attn_D2_Model
        model = Pix2Pix_attn_D2_Model()
    elif opt.model == 'pix2pix_attn_student':
        from .pix2pix_attn_student_model import Pix2Pix_attn_Student_Model
        model = Pix2Pix_attn_Student_Model()
    elif opt.model == 'pix2pix_attn_student_dist':
        from .pix2pix_attn_student_dist_model import Pix2Pix_attn_Student_DIST_Model
        model = Pix2Pix_attn_Student_DIST_Model()
    elif opt.model == 'pix2pix_attn_student_fsp':
        from .pix2pix_attn_student_fsp_model import Pix2Pix_attn_Student_FSP_Model
        model = Pix2Pix_attn_Student_FSP_Model()
        ...
        model = TestModel()
    elif opt.model == 'cycle_attn_gan_model_eg_implementation_vandita':
        from .cycle_attn_gan_model_eg_implementation_vandita_model import CycleAttnGANModel_sar
        model = CycleAttnGANModel_sar()
    else:
