...
Run from domain_adapt/methods/coral/:
...
# ── Path setup ────────────────────────────────────────────────────────────────
# Makes final_student/{models,util,pytorch_ssim} importable by the parent model
# classes, and final_student/coral/ importable by bare module name.
_PKG_ROOT = Path(__file__).resolve().parents[1]     # final_student/
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--checkpoints_dir",
                   default=str(_PKG_ROOT / "outputs" / "checkpoints"),
